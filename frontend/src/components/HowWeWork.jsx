                ...
                <div className="max-w-6xl mx-auto pb-20">
                    ...
                    <section className="text-center mb-20">
                        ...
                        <p className="text-lg md:text-xl leading-relaxed max-w-3xl mx-auto opacity-80">
                            Our healing sessions are a blend of intuitive energy work,
                    ...
                    <section className="grid md:grid-cols-3 gap-10">
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-lg border border-[#e6dbc0]">
                            ...
                            <p className="opacity-80 leading-relaxed">
                                We scan your energy field, identify blockages, and guide you
                    ...
                    <section className="text-center mt-24">
                        ...
                        <p className="max-w-2xl mx-auto text-lg opacity-80 mb-10">
                            Your healing journey starts with one step — and we’re here to guide
                            you every moment through it.
                        </p>

                        <NavLink
                            to="/bookMySession"
                            className="w-fit px-8 py-4 bg-[#050505] text-white rounded-full flex items-center gap-3 mx-auto hover:opacity-90 transition"
                        >
